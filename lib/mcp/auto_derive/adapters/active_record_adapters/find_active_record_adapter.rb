  ...
  module AutoDerive
    module Adapters
      module ActiveRecordAdapters
        class FindActiveRecordAdapter < FastMcp::AutoDerive::AutoDeriveAdapter
          ...
          def self.subclass_params
            {
              ...
              finder_key: nil,
              post_process: nil,
              title: 'Find a record by model name and ID',
              annotations: {
                readOnlyHint: true,
